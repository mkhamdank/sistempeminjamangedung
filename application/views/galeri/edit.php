    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Galeri</div>
        <div class="card-body">
          <?php echo form_open_multipart('galeri/edit/'.$this->uri->segment(3).'/'.$this->uri->segment(4)); ?>
          <?php echo validation_errors() ?>
            <?php foreach ($galeri as $key) { ?>
              <div class="form-group">
                <label for="">Judul</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->judul ?>" name="judul">
              </div>

              <div class="form-group">
                <label for="">Tanggal</label>
                <input type="date" class="form-control" id="" value="<?php echo $key->tanggal ?>" name="tanggal">
              </div>

              <div class="form-group">
                <label for="">Deskripsi</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->deskripsi ?>" name="deskripsi">
              </div>

              <div class="form-group">
              <label for="">Foto</label><br>
              <img width="50px" src="<?=base_url("assets/uploads")."/".$key->foto ?>">
              <input type="hidden" name="foto" id="input" class="form-control" value="<?php echo $key->foto ?>">
