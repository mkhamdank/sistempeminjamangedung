  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="<?php echo site_url('skpd') ?>">SKPD</a>
        </li>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <?php echo form_open('skpd/edit/'.$this->uri->segment(3)); ?>
          <?php echo validation_errors() ?>
            <?php foreach ($skpd as $key) { ?>
              <div class="form-group">
                <label for="">Nama SKPD</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->nama_skpd ?>" name="nama_skpd">
              </div>

              <div class="form-group">
                <label for="">Kepala Dinas</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->kepdin ?>" name="kepdin">
              </div>
            <?php } ?>
