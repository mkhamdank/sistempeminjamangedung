  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <?php echo form_open('skpd/create'); ?>
          <?php echo validation_errors() ?>
            <div class="form-group">
              <label for="">Nama SKPD</label>
              <input type="text" class="form-control" id="" placeholder="Nama SKPD" name="nama_skpd">
            </div>

            <div class="form-group">
              <label for="">Kepala Dinas</label>
              <input type="text" class="form-control" id="" placeholder="Kepala Dinas" name="kepdin" value="---">
            </div>
