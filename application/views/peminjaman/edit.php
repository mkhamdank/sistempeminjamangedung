    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Peminjaman</div>
        <div class="card-body">
          <?php echo form_open('peminjaman/edit/'.$this->uri->segment(3)); ?>
          ...
          <?php foreach ($peminjaman as $key) { ?>
            ...
            <div class="form-group">
              ...
              <select name="fk_skpd" id="inputFk_skpd" class="form-control">
                <option value="<?php echo $key->id_skpd ?>">---</option>
                <?php foreach ($skpd as $val) { ?>
                  <option value="<?php echo $val->id_skpd ?>"><?php echo $val->nama_skpd ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="fk_gedung" id="inputFk_skpd" class="form-control">
                <option value="<?php echo $key->id_gedung ?>">---</option>
                <?php foreach ($gedung as $vul) { ?>
                  <option value="<?php echo $vul->id_gedung ?>"><?php echo $vul->nama_gedung ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="date" name="tanggal" id="inputTanggal" class="form-control" title="" value="<?php echo $key->tanggal ?>">
            </div>

            <div class="form-group">
              <label for="">Jam Mulai</label>
              <input type="time" name="jam" id="inputJam" class="form-control" title="" value="<?php echo $key->jam ?>">
            </div>

            <div class="form-group">
              <label for="">Jam Selesai</label>
              <input type="time" name="jam_selesai" id="inputJam" class="form-control" title="" value="<?php echo $key->jam_selesai ?>">
            </div>

            <div class="form-group">
              <label for="">Jumlah Orang</label>
              <input type="text" name="jumlah_orang" id="" class="form-control" title="" value="<?php echo $key->jumlah_orang ?>">
            </div>

            <div class="form-group">
              <label for="">Acara</label>
              <input type="text" name="acara" id="" class="form-control" value="<?php echo $key->acara ?>">
            </div>

            <div class="form-group">
              <label for="">Keterangan</label>
              <input type="text" name="keterangan" id="" class="form-control" value="<?php echo $key->keterangan ?>">
            </div>
