  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <?php echo form_open('gedung/edit/'.$this->uri->segment(3)); ?>
          <?php echo validation_errors() ?>
            <?php foreach ($gedung as $key) { ?>
              <div class="form-group">
                <label for="">Nama Gedung</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->nama_gedung ?>" name="nama_gedung">
              </div>

              <div class="form-group">
                <label for="">Status</label>
                <input type="text" class="form-control" id="" value="<?php echo $key->status ?>" name="status">
              </div>
            <?php } ?>
