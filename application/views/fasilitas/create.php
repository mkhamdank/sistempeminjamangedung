  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <?php echo form_open('fasilitas/create/'.$this->uri->segment(3)); ?>
          <?php echo validation_errors() ?>
            <div class="form-group">
              <label for="">Jumlah</label>
              <input type="text" class="form-control" id="" placeholder="Jumlah" name="jumlah">
            </div>

            <div class="form-group">
              <label for="">Jenis</label>
              <input type="text" class="form-control" id="" placeholder="Jenis" name="jenis">
            </div>
