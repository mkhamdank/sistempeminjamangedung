  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tambah Fasilitas Gedung</li>
      </ol>
      <!-- Icon Cards-->
      <div class="row">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <legend>Edit Fasilitas Gedung</legend>
          <?php echo form_open('fasilitas/edit/'.$this->uri->segment(3)); ?>
          <?php echo validation_errors() ?>
          <?php foreach ($fasilitas as $key) { ?>
            <div class="form-group">
              <label for="">Jumlah</label>
              <input type="text" class="form-control" id="" value="<?php echo $key->jumlah ?>" name="jumlah">
            </div>

            <div class="form-group">
              <label for="">Jenis</label>
              <input type="text" class="form-control" id="" value="<?php echo $key->jenis ?>" name="jenis">
            </div>
          <?php } ?>
